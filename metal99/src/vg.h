...
/*
 * vg_present() was retired 2026-08-26 - see archive/retired/vg_present.c.
 *
 * It elided at ROW granularity: which rows carry a segment this frame and
 * last, marked into elide. tile_present does the same job per tile and
 * measured strictly better on the same scene, 27.6% of pixels against 88.7%.
 * A vector app presents with tile_present(vg_rowfn).
 */
